...
public class _6_Min_And_Max_Value {
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<totalCurrentPrice.size();i++)
		{
			...
			if(min>value)
			{
				...
				companyNameSmall=totalCompany.get(i).getText();
			}
		 ...
		 System.out.println("The " + companyNameSmall + " minimum Current Price (Rs) - "+min);
